...
export class CompanyCodeService {
  ...
  getAllLanguageDetails() {
    return this.http.get(`http://54.151.187.67:4000/api/master/language/getAll`).toPromise()
  }
 ...
 getAllCurrencyDetails(companyId?:any) {
    return this.http.get(`http://54.151.187.67:4000/api/config/currency/getAll/`).toPromise()
  }
  ...
  companyLogUpload(data:any){
    return this.http.post('http://54.151.187.67:4000/api/upload', data).toPromise()
  }

  getAllAccountGroup(){
    return this.http.get('http://54.151.187.67:4000/api/config/accountGroup/getAll').toPromise()
  }
