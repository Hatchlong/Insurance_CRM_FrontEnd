...
export class BillingBlockService {
  ...
  updateBillingBlockMany(data: any) {
    return this.http.put(`http://54.151.187.67:4000/api/master/billingblock/update`, data).toPromise()
  }

 
  fileUploadBillingBlock(data: any) {
    return this.http.post(`http://54.151.187.67:4000/api/master/billingblock/upload`, data).toPromise()
  }
