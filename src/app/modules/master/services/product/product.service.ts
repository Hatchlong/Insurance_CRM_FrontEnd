...
export class ProductService {
  ...
  getAllBatchManagmentDetails() {
    return this.http.get('http://54.151.187.67:4000/api/config/batch/getAll').toPromise()
  }
  getAllAvailibityCheckDetails(){
    return this.http.get('http://54.151.187.67:4000/api/config/availibityCheck/getAll').toPromise()

  }
  getAllBOMRelevanceDetails(){
    return this.http.get('http://54.151.187.67:4000/api/config/BOM/getAll').toPromise()

  }
  getAllExpirationRelavanceDetails(){
    return this.http.get('http://54.151.187.67:4000/api/config/expirationData/getAll').toPromise()
